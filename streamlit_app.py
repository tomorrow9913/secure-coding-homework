    ...
    if not st.session_state.logged_in:
        ...
        with col1:
            ...
            if st.button('Login'):
                ...
                if response.status_code == 200:
                    ...
                    st.session_state.user = response.json()["username"]
        ...
        with col2:
            ...
            if st.button('Sign Up'):
                response = requests.get(f'{connect_string}/auth/register',
    ...
    if st.session_state.logged_in:
        if st.session_state.user["role"] == 'admin':
            ...
            if choice == 'Home':
                ...
                response = requests.get(f'{connect_string}/products')
                ...
                with st.form(key='add_product_form'):
                    ...
                    if submit_button:
                        add_product_response = requests.get(f'{connect_string}/add_product',
            ...
            if choice == 'Home':
                ...
                with st.form(key='edit_user_info_form'):
                    ...
                    if submit_button:
                        response = requests.get(f'{connect_string}/update_user_info',
